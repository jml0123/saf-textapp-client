...
export default class EditUserForm extends Component {
  ...
  handleCopy = (e) => {
    ...
    navigator.clipboard.writeText(
      `https://saf-textapp-client.jml0123.vercel.app/profiles/${this.state.user.id}`
    );
    this.setState({
      ...this.state,
      copiedLink: true,
    ...
    return (
      <div className="edit-wrapper">
        <div className="edit-container" ref={this.containerRef}>
          <button
            type="button"
            onClick={this.props.toggleEditView}
          ...
          <form id="edit-user" name="edit-user" onSubmit={this.handleEditUser}>
            ...
            <div className="profile-img-container--edit">
              <div className="profile-img-wrapper--edit">
                <img
                  src={this.state.user.profile_img_link}
                  alt="user-profile"
                />
              </div>
            </div>
            ...
            <input
              ...
              onChange={(e) => this.updatedisplayName(e)}
            />
            <label htmlFor="profile_img_link">
              Link a profile image here (must be hosted online)
            </label>
            <input
              type="text"
              id="profile_img_link"
              name="profile_img_link"
              defaultValue={this.props.user.profile_img_link}
              onChange={(e) => this.updateProfileImg(e)}
            />
            ...
            <textarea
              ...
              defaultValue={this.props.user.profile_description}
              onChange={(e) => this.updateProfileDesc(e)}
            ></textarea>
            ...
            <div className="share-profile-wrapper">
              <div className="share-profile-img-container">
                <img
                  ...
                  src="https://image.flaticon.com/icons/png/512/25/25419.png"
